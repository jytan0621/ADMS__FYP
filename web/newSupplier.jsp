<%-- 
    ...
    Created on : Apr 14, 2026, 5:04:32 PM
    Author     : User
--%>
    ...
    <div class="main-content">
        <div class="card">
            <h3 style="margin-top:0; color: #0f172a; border-bottom: 2px solid #f1f5f9; padding-bottom: 15px; margin-bottom: 25px;">
                <i class="fas fa-building" style="color:#0b5ea8; margin-right:10px;"></i> Register New Supplier
            </h3>
            
            <form action="insertSupplier" method="POST">
                <label>Company / Supplier Name</label>
                <input type="text" name="supplierName" class="form-control" required placeholder="e.g. Gardenia Sdn Bhd">
                
                <label>Contact Number (S_CNumber)</label>
                <input type="text" name="sCNumber" class="form-control" required placeholder="e.g. 012-3456789">
                
                <div style="margin-top: 10px;">
                    <button type="submit" class="btn-submit"><i class="fas fa-save"></i> Save Supplier</button>
                    <a href="listSupplier" class="btn-cancel">Cancel</a>
                </div>
            </form>
        </div>
    </div>
